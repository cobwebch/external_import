...
:code:`\Cobweb\ExternalImport\Domain\Model\Data` class. This class contains
...
into an instance of the :code:`\Cobweb\ExternalImport\Domain\Model\Configuration` class.

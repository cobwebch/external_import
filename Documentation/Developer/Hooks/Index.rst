...
preprocessRawRecordset
  ...
  object (an instance of class :code:`tx_externalimport_importer`) as
...
validateRawRecordset
  ...
  :code:`tx_externalimport_importer`) as parameters. It is expected
...
deletePreProcess
  ...
  instance of class :code:`tx_externalimport_importer`). The method invoked is
...
datamapPostProcess
  ...
  instance of class :code:`tx_externalimport_importer`). Each record contains
  an additional field called :code:`tx_exteralimport:status` which contains
...
cmdmapPostProcess
  ...
  :code:`tx_externalimport_importer`).

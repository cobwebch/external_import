...
class StoreDataStepTest extends FunctionalTestCase
{
     ...
     */
    public function handleMmRelationsPreparesMappings($prerequisites, $ctrlConfiguration, $columnConfiguration, $records, $expectedMappings, $expectedFullMappings): void
    {
